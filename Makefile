...
sendmessages:
	...
	curl -i -XGET http://localhost:8000/message -H "Authorization: Bearer $(ELDIUS_BEARER)" -d '{"to": "eldius","msg": "My new message 01!"}' 2>/dev/null
	curl -i -XGET http://localhost:8000/message -H "Authorization: Bearer $(ELDIUS_BEARER)" -d '{"to": "test1","msg": "My new message 02!"}' 2>/dev/null
	curl -i -XGET http://localhost:8000/message -H "Authorization: Bearer $(ELDIUS_BEARER)" -d '{"to": "test2","msg": "My new message 03!"}' 2>/dev/null
	curl -i -XGET http://localhost:8000/message -H "Authorization: Bearer $(ELDIUS_BEARER)" -d '{"to": "testUser","msg": "My new message 04!"}' 2>/dev/null
	curl -i -XGET http://localhost:8000/message -H "Authorization: Bearer $(ELDIUS_BEARER)" -d '{"to": "testUser","msg": "My new message 05!"}' 2>/dev/null
	curl -i -XGET http://localhost:8000/message -H "Authorization: Bearer $(ELDIUS_BEARER)" -d '{"to": "testUser","msg": "My new message 06!"}' 2>/dev/null
	curl -i -XGET http://localhost:8000/message -H "Authorization: Bearer $(ELDIUS_BEARER)" -d '{"to": "testUser","msg": "My new message 07!"}' 2>/dev/null
	curl -i -XGET http://localhost:8000/message -H "Authorization: Bearer $(TEST_BEARER)" -d '{"to": "eldius","msg": "My new message 08!"}' 2>/dev/null
	curl -i -XGET http://localhost:8000/message -H "Authorization: Bearer $(TEST1_BEARER)" -d '{"to": "eldius","msg": "My new message 09!"}' 2>/dev/null
	curl -i -XGET http://localhost:8000/message -H "Authorization: Bearer $(TEST2_BEARER)" -d '{"to": "eldius","msg": "My new message 10!"}' 2>/dev/null
	curl -i -XGET http://localhost:8000/message -H "Authorization: Bearer $(TEST_BEARER)" -d '{"to": "eldius","msg": "My new message 11!"}' 2>/dev/null
	curl -i -XGET http://localhost:8000/message -H "Authorization: Bearer $(TEST_BEARER)" -d '{"to": "eldius","msg": "My new message 12!"}' 2>/dev/null
